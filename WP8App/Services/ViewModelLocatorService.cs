...
namespace WPAppStudio.Services
{
    ...
    public class ViewModelLocatorService
    {
        ...
        /// <summary>
        /// Gets the reference to a BLOGPOSTS_NewsViewModel.
        /// </summary>
		public IViewModels.IBLOGPOSTS_NewsViewModel BLOGPOSTS_NewsViewModel
        {
            get { return _container.Resolve<IViewModels.IBLOGPOSTS_NewsViewModel>(); }
        }

        /// <summary>
        /// Gets the reference to a BLOGPOSTS_DetailViewModel.
        /// </summary>
		public IViewModels.IBLOGPOSTS_DetailViewModel BLOGPOSTS_DetailViewModel
        {
            get { return _container.Resolve<IViewModels.IBLOGPOSTS_DetailViewModel>(); }
        }
		/// <summary>
